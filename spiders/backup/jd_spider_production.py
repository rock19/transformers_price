#!/usr/bin/env python3
"""
京东爬虫 - 最终版（使用 base64 编码执行 JavaScript）
"""
...
def get_detail_price(url):
    ...
    js_code = '''
var price = 0;
var priceElem = document.querySelector(".p-price i") || document.querySelector(".jd-price");
if(priceElem) {
...
def main():
    ...
    # 显示商品
    for i, p in enumerate(unique_products[:15], 1):
